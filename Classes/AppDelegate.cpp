...
bool AppDelegate::applicationDidFinishLaunching() {
    ...
    if(!glview) {
        ...
        glview = GLViewImpl::createWithRect("Gameforlwh", cocos2d::Rect(0, 0, designResolutionSize.width, designResolutionSize.height));
#else
    ...
    std::vector<std::string> path = FileUtils::sharedFileUtils()->getSearchPaths();
